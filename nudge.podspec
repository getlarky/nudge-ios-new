...
Pod::Spec.new do |s|
  s.name             = 'nudge'
  s.version          = '0.1.0'
  s.summary          = 'A short description of nudge.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/bromeostasis/nudge'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'bromeostasis' => 'evan.snyder92@gmail.com' }
  s.source           = { :git => 'https://github.com/bromeostasis/nudge.git', :tag => s.version.to_s }
